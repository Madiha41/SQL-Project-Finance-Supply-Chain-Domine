...
[View Report](https://github.com/Madiha41/SQL-Project-Finance-Supply-Chain-Domine/blob/main/Croma%20India%20Product-Wise%20Sales%20Report%20for%20Fiscal%20Year%202021.csv) <!-- Replace '#' with the actual link to the report file -->
...
[View Report](https://github.com/Madiha41/SQL-Project-Finance-Supply-Chain-Domine/blob/main/Gross%20Monthly%20Total%20Sales%20Report%20for%20Croma.csv) <!-- Replace '#' with the actual link to the report file -->
...
- **Report for Top Markets:**
  ...
  [View Report](https://github.com/Madiha41/SQL-Project-Finance-Supply-Chain-Domine/blob/main/top_n_markets_by_netsales.csv) <!-- Replace '#' with the actual link to the report file -->
...
[View Report](ttps://github.com/Madiha41/SQL-Project-Finance-Supply-Chain-Domine/blob/main/top_n_market_by_region.csv) <!-- Replace '#' with the actual link to the report file -->
...
[View Report](https://github.com/Madiha41/SQL-Project-Finance-Supply-Chain-Domine/blob/main/forecast_accuracy_pct_2021.csv) <!-- Replace '#' with the actual link to the report file -->
